...
var p5 = function(sketch, node, sync) {
  ...
  var methods = Object.getOwnPropertyNames(p5._registeredMethods);
  for (var i = 0; i < methods.length; i++) {
    var prop = methods[i];
    this._registeredMethods[prop] = p5._registeredMethods[prop].slice();
  }
...
p5._registeredMethods = { init: [], pre: [], post: [], remove: [] };

p5._registeredPreloadMethods = {};

p5.registerPreloadMethod = function(fnString, obj) {
  // obj = obj || p5.prototype;
  if (!p5._preloadMethods.hasOwnProperty(fnString)) {
